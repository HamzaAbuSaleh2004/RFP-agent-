...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "eval.submit_bids":       {"en": "Submit Vendor Bids",    "ar": "تقديم عروض الموردين"},
    "eval.submit_bids_desc":  {"en": "Add vendor bids by pasting content or uploading PDF/DOCX files, then run the evaluation.",
                                "ar": "أضف عروض الموردين بلصق المحتوى أو رفع ملفات PDF/DOCX، ثم ابدأ التقييم."},
    "eval.vendor_name":       {"en": "Vendor Name",           "ar": "اسم المورد"},
    "eval.company_name":      {"en": "Company",               "ar": "الشركة"},
    "eval.paste_bid":         {"en": "Paste bid content…",    "ar": "الصق محتوى العرض…"},
    "eval.or_upload":         {"en": "or upload file",        "ar": "أو ارفع ملف"},
    "eval.add_bid":           {"en": "Add Another Bid",       "ar": "إضافة عرض آخر"},
    "eval.run_evaluation":    {"en": "Run Evaluation",        "ar": "بدء التقييم"},
    "eval.processing":        {"en": "Evaluating bids…",      "ar": "جارٍ تقييم العروض…"},
    "eval.processing_desc":   {"en": "The AI agent is analyzing all bids against company benchmarks. This may take a minute.",
                                "ar": "يقوم الوكيل الذكي بتحليل جميع العروض مقابل معايير الشركة. قد يستغرق ذلك دقيقة."},
    "eval.bid_number":        {"en": "Bid",                   "ar": "عرض"},
    "eval.remove_bid":        {"en": "Remove",                "ar": "حذف"},
    "eval.upload_pdf_docx":   {"en": "Upload PDF/DOCX",       "ar": "رفع PDF/DOCX"},
    "eval.file_attached":     {"en": "File attached",         "ar": "تم إرفاق الملف"},
    "eval.min_bids_error":    {"en": "Please add at least 2 vendor bids to evaluate.",
                                "ar": "يرجى إضافة عرضين على الأقل للتقييم."},
    "eval.fill_all_error":    {"en": "Please fill in vendor name and bid content for all entries.",
                                "ar": "يرجى ملء اسم المورد ومحتوى العرض لجميع الإدخالات."},

    # ── Evaluations page (extended) ───────────────────────────────────────────
    "eval.dashboard_heading": {"en": "Evaluations Dashboard",
                                "ar": "لوحة التقييمات"},
    "eval.dashboard_subtitle":{"en": "Select a published RFP below to evaluate vendor bids and determine the optimal choice.",
                                "ar": "اختر طلب عروض منشوراً أدناه لتقييم عروض الموردين وتحديد الخيار الأمثل."},
    "eval.no_published":      {"en": "No published RFPs available for evaluation.",
                                "ar": "لا توجد طلبات عروض منشورة متاحة للتقييم."},
    "eval.collaborators":     {"en": "Collaborators",          "ar": "متعاونون"},
    "eval.bid_content":       {"en": "Bid Content",            "ar": "محتوى العرض"},
    "eval.agent_benchmarks":  {"en": "The AI agent will evaluate all bids against your company's Legal, Commercial, Technical, and Financial benchmarks.",
                                "ar": "سيقوم الوكيل الذكي بتقييم جميع العروض وفق معايير الشركة القانونية والتجارية والتقنية والمالية."},
    "eval.evaluated_on":      {"en": "Evaluated on",           "ar": "تم التقييم في"},
    "eval.reevaluate":        {"en": "Re-evaluate",            "ar": "إعادة التقييم"},
    "eval.ai_recommendation": {"en": "AI RECOMMENDATION",      "ar": "توصية الذكاء الاصطناعي"},
    "eval.download_brief":    {"en": "Download Brief",         "ar": "تنزيل الملخص"},
    "eval.total_contract_value": {"en": "TOTAL CONTRACT VALUE",
                                   "ar": "إجمالي قيمة العقد"},
    "eval.evaluation_status": {"en": "EVALUATION STATUS",      "ar": "حالة التقييم"},
    "eval.final_comparison":  {"en": "Final Comparison",       "ar": "المقارنة النهائية"},
    "eval.vendors_evaluated": {"en": "vendors evaluated",      "ar": "موردون تم تقييمهم"},
    "eval.risk_heatmap":      {"en": "Risk Heatmap",           "ar": "خريطة المخاطر"},
    "eval.risk_heatmap_desc": {"en": "Per-dimension risk exposure across all vendors",
                                "ar": "توزيع المخاطر لكل بُعد عبر جميع الموردين"},
    "eval.risk_low":          {"en": "LOW",                    "ar": "منخفض"},
    "eval.risk_moderate":     {"en": "MODERATE",               "ar": "متوسط"},
    "eval.risk_high":         {"en": "HIGH",                   "ar": "مرتفع"},
    "eval.risk_critical":     {"en": "CRITICAL",               "ar": "حرج"},
    "eval.risk_exposure":     {"en": "Risk Exposure",          "ar": "درجة المخاطرة"},
    "eval.score_trend":       {"en": "Predictive Score Trend", "ar": "اتجاه الدرجات المتوقع"},
    "eval.confirm_vendor":    {"en": "Confirm vendor selection and close the RFP.",
                                "ar": "أكّد اختيار المورد وأغلق طلب العروض."},
    "eval.award_question":    {"en": "Award this RFP to",
                                "ar": "هل تريد ترسية طلب العروض هذا إلى"},
    "eval.award_effect":      {"en": "This will mark the RFP as done and assign the vendor.",
                                "ar": "سيتم وضع علامة على طلب العروض بأنه مكتمل وتعيين المورد."},
    "eval.confirm_award":     {"en": "Confirm Award",          "ar": "تأكيد الترسية"},
    "eval.criteria":          {"en": "Criteria",               "ar": "المعايير"},
    "eval.dimension":         {"en": "Dimension",              "ar": "البُعد"},
    "eval.optimal_choice":    {"en": "OPTIMAL CHOICE",         "ar": "الخيار الأمثل"},
    "eval.row.legal":         {"en": "Legal Compliance",       "ar": "الامتثال القانوني"},
    "eval.row.legal_sub":     {"en": "GDPR & ISO Compliance",  "ar": "امتثال GDPR وISO"},
    "eval.row.commercial":    {"en": "Commercial Terms",       "ar": "الشروط التجارية"},
    "eval.row.commercial_sub":{"en": "MSAs & SLAs",            "ar": "اتفاقيات MSA وSLA"},
    "eval.row.technical":     {"en": "Technical Capability",   "ar": "القدرة التقنية"},
    "eval.row.technical_sub": {"en": "Performance Score (0-100)",
                                "ar": "درجة الأداء (0-100)"},
    "eval.row.financial":     {"en": "Financial Stability",    "ar": "الاستقرار المالي"},
    "eval.row.financial_sub": {"en": "Credit & Revenue Check", "ar": "فحص الائتمان والإيرادات"},
    "eval.row.flags":         {"en": "Flags",                  "ar": "تنبيهات"},
    "eval.row.flags_sub":     {"en": "Risk indicators",        "ar": "مؤشرات المخاطر"},
    "eval.dim.legal":         {"en": "Legal",                  "ar": "قانوني"},
    "eval.dim.commercial":    {"en": "Commercial",             "ar": "تجاري"},
    "eval.dim.technical":     {"en": "Technical",              "ar": "تقني"},
    "eval.dim.financial":     {"en": "Financial",              "ar": "مالي"},
    "eval.dim.overall":       {"en": "Overall",                "ar": "الإجمالي"},
    "eval.result.pass":       {"en": "PASS",                   "ar": "ناجح"},
    "eval.result.fail":       {"en": "FAIL",                   "ar": "راسب"},
    "eval.project_tag":       {"en": "PROJECT",                "ar": "المشروع"},
    "eval.unknown":           {"en": "Unknown",                "ar": "غير معروف"},
    "eval.tech_leads":        {"en": "leads with a Technical Score of",
                                "ar": "في الصدارة بدرجة تقنية قدرها"},
    "eval.awarded_toast":     {"en": "RFP awarded to",          "ar": "تمت ترسية طلب العروض إلى"},
    "eval.award_failed":      {"en": "Award failed",            "ar": "فشلت الترسية"},
    "eval.eval_failed":       {"en": "Evaluation failed",       "ar": "فشل التقييم"},
    "eval.select_first":      {"en": "Please select an RFP first",
                                "ar": "يرجى اختيار طلب عروض أولاً"},
    "eval.no_rec":            {"en": "No recommendation available",
                                "ar": "لا توجد توصية متاحة"},
    "eval.file_error":        {"en": "File error",              "ar": "خطأ في الملف"},
    "eval.extracting":        {"en": "Extracting text from",   "ar": "جارٍ استخراج النص من"},
    "eval.example_vendor":    {"en": "e.g. Acme Corp",          "ar": "مثال: شركة أكمي"},
    "eval.example_company":   {"en": "e.g. Acme Solutions Ltd.",
                                "ar": "مثال: أكمي للحلول المحدودة"},
}
